        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointFidelite = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteGlobale = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAvis = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Avis_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumTel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Salaire = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    RestaurantId = table.Column<int>(type: "int", nullable: false),
                    TypeEmploye = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    Specialite = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AnneeExp = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    Note = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employes_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixTotal = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    DisponibleDu = table.Column<TimeSpan>(type: "time", nullable: true),
                    RestaurantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatutReservation = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Avis_RestaurantId",
                table: "Avis",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Employes_RestaurantId",
                table: "Employes",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TablesRestaurant_RestaurantId_Numero",
                table: "TablesRestaurant",
                columns: new[] { "RestaurantId", "Numero" },
                unique: true);
        }
